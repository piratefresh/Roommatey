...
})(["position:relative;display:grid;grid-template-columns:[profileImage]1fr [task]3fr [metadata]1fr;align-items:center;background:#fff;box-shadow:", ";border-radius:5px;padding:5% 2%;width:90vw;font-size:1.5rem;margin-bottom:5%;img{grid-column:profileImage;border-radius:10%;}p{margin-right:5px;}span{font-size:1rem;color:", ";}"], function (props) {
...
//# sourceMappingURL=index.js.966b9b8db0bf4baf1eb9.hot-update.js.map